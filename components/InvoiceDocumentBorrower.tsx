...
const InvoiceDocument = ({ issuedDate, payeeIdentity, firstName, lastName, email, address, city, postalCode, country, borrowingToken, borrowingAmount, description, tokenOptions }) => (
  <Document>
    <Page style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>{payeeIdentity}</Text>
      </View>
      <View style={styles.section}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>Token: {tokenOptions[borrowingToken]} - {borrowingToken}</Text>
        <Text style={styles.text}>Amount: {borrowingAmount}</Text>
